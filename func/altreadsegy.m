...
%version20170828,read DIY 3c microseismic model
function [dataout, samplen, sampfre, samptrace, traceheaders, varargout] = altreadsegy(sgyfile, varargin)
